...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="{{asset('about')}}/css/unicons.css">
    ...
    <!-- MAIN STYLE -->
    <link rel="stylesheet" href="{{asset('about')}}/css/tooplate-style.css">
...
@include('components/header')
            ...
            <div class="row">
                ...
                <div class="col-lg-5 col-md-12 col-12">
                    <div class="about-image svg">
                        <img src="{{asset('about')}}/images/undraw/undraw_software_engineer_lvl5.svg" class="img-fluid" alt="svg image">
                    </div>
                </div>
                      ...
                      <div class="owl-carousel owl-theme">
                        <div class="item">
                          <div class="project-info">
                            <img src="{{asset('about')}}/images/project/project-image01.png" class="img-fluid" alt="project image">
                          </div>
                        </div>

                        <div class="item">
                          <div class="project-info">
                            <img src="{{asset('about')}}/images/project/project-image02.png" class="img-fluid" alt="project image">
                          </div>
                        </div>

                        <div class="item">
                          <div class="project-info">
                            <img src="{{asset('about')}}/images/project/project-image03.png" class="img-fluid" alt="project image">
                          </div>
                        </div>

                        <div class="item">
                          <div class="project-info">
                            <img src="{{asset('about')}}/images/project/project-image04.png" class="img-fluid" alt="project image">
                          </div>
                        </div>

                        <div class="item">
                          <div class="project-info">
                            <img src="{{asset('about')}}/images/project/project-image05.png" class="img-fluid" alt="project image">
                          </div>
                        </div>
                      </div>
                  ...
                  <h2 class="mb-4 mobile-mt-2">Educations</h2>
                    ...
                    <div class="timeline">
                        ...
                        <div class="timeline-wrapper">
                            ...
                            <div class="timeline-info">
                                <h3><span>Student</span><small>HoChiMinh University of Technology</small></h3>
    ...
    <script src="{{asset('about')}}/js/Headroom.js"></script>
    <script src="{{asset('about')}}/js/jQuery.headroom.js"></script>
    <script src="{{asset('about')}}/js/owl.carousel.min.js"></script>
    <script src="{{asset('about')}}/js/smoothscroll.js"></script>
    <script src="{{asset('about')}}/js/custom.js"></script>
